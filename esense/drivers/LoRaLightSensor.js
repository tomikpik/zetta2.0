...
LoRaLightSensor.prototype.processData = function(data) {
	...
	switch(exponent){
		case 0: //*0.015625
			this.illumination= result>>6;
			break;
		case 1: //*0.03125
			this.illumination= result>>5;
			break;
		case 2: //*0.0625
			this.illumination= result>>4;
			break;
		case 3: //*0.125
			this.illumination= result>>3;
			break;
		case 4: //*0.25
			this.illumination= result>>2;
			break;
		case 5: //*0.5
			this.illumination= result>>1;
			break;
		case 6:
			this.illumination= result;
			break;
		case 7: //*2
			this.illumination= result<<1;
			break;
